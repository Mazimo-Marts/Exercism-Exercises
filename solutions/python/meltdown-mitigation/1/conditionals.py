...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    centoDezPorcento = threshold * 1.1
    noventaPorcento = threshold * 0.9
    oitentaPorcento = threshold * 0.8

    if test  < noventaPorcento:
        return 'LOW'
    elif centoDezPorcento > test > noventaPorcento:
        return 'NORMAL'
    else:
        return 'DANGER'
