...
def check_drinks(drink_name, drink_ingredients):
    ...
    if ALCOHOLS.isdisjoint(drink_ingredients):
        answer = f'{drink_name} Mocktail'
    else:
        answer = f'{drink_name} Cocktail'
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if dish_ingredients.issubset(VEGAN):
        answer = f'{dish_name}: VEGAN'
    elif dish_ingredients.issubset(VEGETARIAN):
        answer = f'{dish_name}: VEGETARIAN'
    elif dish_ingredients.issubset(PALEO):
        answer = f'{dish_name}: PALEO'
    elif dish_ingredients.issubset(KETO):
        answer = f'{dish_name}: KETO'
    else:
        answer = f'{dish_name}: OMNIVORE'
...
def singleton_ingredients(dishes, intersection):
    ...
    answer = set()
    for dish in dishes:
        aux.append(dish.difference(intersection))
    for items in aux:
        answer = answer.union(items)
    return answer
